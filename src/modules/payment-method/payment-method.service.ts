...
export class PaymentMethodService {
    ...
    async createPaymentMethod(data: CreatePaymentMethodDto, userId: number) {
        ...
        const addedPaymentMethod =
            await this.prismaService.payment_method.create({
                data: {
    ...
    async getAllPaymentMethods(userId: number) {
        const paymentMethods = await this.prismaService.payment_method
            .findMany({
                where: {
                    user_id: userId,
                },
    ...
    async deletePaymentMethod(
        ...
        const deletedPaymentMethod =
            await this.prismaService.payment_method.delete({
                where: {
